...
std::vector<std::vector<float>> forward(const std::vector<std::vector<float>> filter,
...
// void updateWeights(const T &eta_, const T &alpha_,
//                    const std::vector<std::vector<float>> &output_grad,
//                    const std::vector<std::vector<float>> &input_act,
